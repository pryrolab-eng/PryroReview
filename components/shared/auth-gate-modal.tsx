  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm rounded-md border border-zinc-200 bg-white p-8 text-center [&>button]:hidden">
        ...
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-md border-2 border-blue-500">
        ...
        <div className="mt-6 flex flex-col gap-2">
          <Link
            href="/register"
            onClick={onClose}
            className="flex items-center justify-center rounded-md bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-600"
          >
            Create account
          </Link>
          <Link
            href="/login"
            onClick={onClose}
            className="flex items-center justify-center rounded-md border-2 border-blue-500 px-5 py-2.5 text-sm font-semibold text-blue-500 hover:bg-blue-500 hover:text-white"
          >
            Sign in
          </Link>
        </div>
