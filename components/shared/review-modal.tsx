            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-zinc-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
                />
              </div>
              <button
                type="button"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select value={category} onChange={(e) => setCategory(e.target.value)}
                  className="h-11 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100">
