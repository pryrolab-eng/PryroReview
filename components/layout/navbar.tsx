  ...
  return (
    <header className="sticky top-0 z-50 w-full flex justify-center">
      <div className={cn(
        ...
        scrolled
          ? 'mt-3 mx-4 max-w-5xl rounded-full border border-zinc-200 bg-white/80 backdrop-blur-md shadow-lg'
          : 'max-w-full bg-white'
      )}>
        <div className={cn(
          'flex h-14 items-center gap-8',
          scrolled ? 'px-5' : 'px-4 sm:px-6 lg:px-8'
        )}>
